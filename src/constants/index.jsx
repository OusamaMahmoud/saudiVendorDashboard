import { ChartColumn, Home, NotepadText, Package, PackagePlus, Users } from "lucide-react";
...
export const navbarLinks = () => [
    ...
    {
        title: i18n.t("menu:vendors"),
        links: [
            {
                label: i18n.t("menu:vendors"),
                icon: Users,
                path: "/vendors",
            },
        ],
    ...
    {
        title: i18n.t("menu:categories"),
        links: [
            {
                label: i18n.t("menu:addCategories"),
                icon: Package,
                path: "/categories/add",
            },
            {
                label: i18n.t("menu:updateCategories"),
                icon: PackagePlus,
